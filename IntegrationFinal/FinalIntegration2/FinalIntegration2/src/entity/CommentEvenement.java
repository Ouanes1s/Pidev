...
public class CommentEvenement {
    ...
    public Evenements getIdEvt() {
        return idEvt;
    }

    public void setIdEvt(Evenements idEvt) {
        this.idEvt = idEvt;
    }
    ...
    public CommentEvenement(Evenements idEvt, User id, int idComment, String Comment) {
        this.idEvt = idEvt;
        this.id = id;
        this.idComment = idComment;
        this.Comment = Comment;
    ...
    public CommentEvenement(Evenements idEvt, User id, String Comment) {
        this.idEvt = idEvt;
        this.id = id;
        this.Comment = Comment;
    }
