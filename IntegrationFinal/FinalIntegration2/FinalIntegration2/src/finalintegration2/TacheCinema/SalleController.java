...
import finalintegration2.Models.Salle;
import finalintegration2.Services.ServiceCinema;
import finalintegration2.Services.ServiceSalle;
import java.net.URL;
...
public class SalleController implements Initializable {
    ...
    private void ajouter(ActionEvent event) throws SQLException {
        ...
        ServiceSalle sc = new ServiceSalle();
        if (nom_salle==null || adresse ==null || num_places==null )      
        {   Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Failed");
            alert.setHeaderText("Attention !!");
            alert.setContentText("Missing Informations");
            alert.show();
        }else if (nom_salle.matches("[a..z]*")==true)
        {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Failed");
            alert.setHeaderText("Attention !!");
            ...
            alert.show();
        }else if(num_places.matches("[0..9]*")==true){
        Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Failed");
            alert.setHeaderText("Attention !!");
