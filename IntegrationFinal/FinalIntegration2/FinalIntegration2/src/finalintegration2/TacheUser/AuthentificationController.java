      ...
      int id=0;
       ...
       ResultSet rs = null;
                  /* System.out.println(authemail.getText()+authmdp.getText());*/
                        ...
                        while (rs.next()) {
                           Session.initialize(rs.getString("nom_user"), rs.getString("cin_user"),rs.getString("role_user"),rs.getString("Type_A"),rs.getString("prenom_user"));
                           ...
                           //id = rs.getInt("id_user");
                            ...
                            if (rs.getString("role_user").equals("Administrateur")){
                                ...
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("../TacheReservation/DashboardReservation.fxml"));
                                    Parent root = loader.load();
                                 Scene scene = new Scene(root);  
                                  Stage primaryStage = new Stage();
                                 primaryStage.setScene(scene);  
                                ...
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("../TacheReservation/DashboardResAgent.fxml"));
                                    Parent root = loader.load();
                                 Scene scene = new Scene(root);  
                                  Stage primaryStage = new Stage();
                                 primaryStage.setScene(scene);  
                                ...
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("../TacheReclamation/GestionGererReclamation.fxml"));
                                    Parent root = loader.load();
                                 Scene scene = new Scene(root);  
                                  Stage primaryStage = new Stage();
                                 primaryStage.setScene(scene);  
                                ...
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/AffichierEvenement.fxml"));
                                    Parent root = loader.load();
                                 Scene scene = new Scene(root);  
                                  Stage primaryStage = new Stage();
                                 primaryStage.setScene(scene);  
                                ...
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("../TacheCinema/GestionCinSal.fxml"));
                                    Parent root = loader.load();
                                 Scene scene = new Scene(root);  
                                  Stage primaryStage = new Stage();
                                 primaryStage.setScene(scene);  
                                ...
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("../TacheReclamation/GestionParkings.fxml"));
                                    Parent root = loader.load();
                                 Scene scene = new Scene(root);  
                                  Stage primaryStage = new Stage();
                                 primaryStage.setScene(scene);  
